...
const VeviozAPI = require("./vevioz");
...
class LintxMP {
    ...
    async getAudioInfo() {
        ...
        // const vevioz = await (new VeviozAPI(video.url)).getAudios();
        // const info = vevioz.quality("128").format("mp3").getInfo();
    ...
    static async convertAudio(url) {
        // const vevioz = await (new VeviozAPi(url)).getAudios();
        // const info = vevioz.quality("128").format("mp3").getInfo();
    ...
    static async convertVideo(url) {
        // const vevioz = await (new VeviozAPI(url)).getVideos();
        // const info = vevioz.quality("480").format("mp4").getInfo();
